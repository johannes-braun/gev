...
namespace gev
{
  std::string_view severity_name(severity s)
  {
    switch (s)
    {
      case severity::debug: return "[\x1B[32m debug \033[0m]";
      case severity::verbose: return "[\x1B[94mverbose\033[0m]";
      case severity::warning: return "[\x1B[33mwarning\033[0m]";
      case severity::error: return "[\x1B[31m error \033[0m]";
      default: return "[\x1B[90m ----- \033[0m]";
    }
  }
