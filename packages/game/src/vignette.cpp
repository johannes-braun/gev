...
namespace gev::game
{
  vignette::vignette()
  {
    ...
    auto const shader = gev::create_shader(gev::load_spv(gev_game_shaders::shaders::vignette_comp));
  ...
  void vignette::apply(vk::CommandBuffer c, float strength, render_target_2d const& src, render_target_2d const& dst)
  {
    ...
    c.pushConstants<float>(_layout.get(), vk::ShaderStageFlagBits::eCompute, 0, strength);
